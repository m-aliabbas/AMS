...
class Answer(models.Model):
    ...
    response_part_flix=models.TextField(max_length=1500,null=True,blank=True) 
    response_part_resource=models.TextField(max_length=1500,null=True,blank=True)
    response_part_early_retirement=models.TextField(max_length=1500,null=True,blank=True)
    response_part_senior_retirement=models.TextField(max_length=1500,null=True,blank=True)
    response_part_forsikrde=models.TextField(max_length=1500,null=True,blank=True)
    response_part_sygedagpenge=models.TextField(max_length=1500,null=True,blank=True)

    response_part_jaf=models.TextField(max_length=1500,null=True,blank=True)
